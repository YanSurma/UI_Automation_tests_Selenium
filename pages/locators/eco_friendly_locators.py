...
ITEM_PRICE = (By.XPATH, '(//span[@class="price-wrapper "])[1]')
COMPARE_ALERT = (By.XPATH, '//div[@data-ui-id="message-success"]')
ITEM_PAGE_NAME = (By.XPATH, '//span[@data-ui-id="page-title-wrapper"]')
ADD_CARD_BUTTON = (By.XPATH, '//button[@title="Add to Cart"]')
